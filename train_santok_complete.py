...
Usage:
    python train_santok_complete.py --data training_data.txt
...
Examples:
  python train_santok_complete.py --data training_data.txt
  python train_santok_complete.py  (auto-detects training data)
  python train_santok_complete.py --data data.txt --epochs 20
        """
    )
    parser.add_argument(
        "--data",
    ...
    if args.data:
        ...
        if data_path:
            ...
            cmd = "python train_santok_complete.py --data your_data.txt"
